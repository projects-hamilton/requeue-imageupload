...
router.get('/Amunt-Details',Amountforeachdriver)
router.get('/get-each-drive-amount',Amountforeachdriver)
...
router.patch('/update-driver-approvel/:id',driverApprovalupdate)
router.get('/driver-all-list', GetAllDriverList)
router.get('/get-by-driver-id/:id',GetByDriverId)
router.get('/get-all-status/:Status', GetByStatus)
